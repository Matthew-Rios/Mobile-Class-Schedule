...
This project is an android application which allows a user to track their terms, classes, and assessments. It uses the room with a view data model. The requirements for the project can be seen below.
